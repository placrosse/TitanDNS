...
public class DNSMessageDecoder extends ReplayingDecoder<DNSMessageDecoderState> {

	public DNSMessageDecoder() {
		super(DNSMessageDecoderState.READ_LENGTH);
	}

	@Override
	protected Object decode(final ChannelHandlerContext context,
			final Channel channel, final ChannelBuffer buffer,
			final DNSMessageDecoderState state) throws Exception {
